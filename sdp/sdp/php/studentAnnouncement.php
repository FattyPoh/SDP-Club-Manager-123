...
$sql = "SELECT * FROM announcement WHERE club_name = '".$_SESSION['enrolledClub']."'";
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
      ...
      <tr>
        ...
        <td><button id='<?php echo $row["announcement_ID"]?>' class="btn btn-primary">Show</button></td>
      </tr>
...
$(document).ready(function(){
  ...
  id_ann = $(this).attr('id')
        $.ajax({url: "display_Announcement.php",
        method:'post',
        data:{ann_id:id_ann},
