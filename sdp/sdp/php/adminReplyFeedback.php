...
<html lang="en">
<head>
     <title>Admin Reply Feedback</title>
     ...
     <div>
          ...
          <div class="box" style="height:680px">
            <div class="content">
                ...
                <h3>Your Reply</h3>
               <input type="text" name="adminText"></input>
                </div>
...
<?php 
    if(isset($_POST["adminText"]) && (isset($_GET['feedbackID']))){
        echo adminReplyFeedback($_POST["adminText"],$_GET['feedbackID']);
        return;
    }
?>
</html>
